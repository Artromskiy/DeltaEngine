...
public abstract class Template
{
    ...
    public string LoopSelect<T>(IEnumerable<T> objects, Func<T, string> selector) => Loop(objects.Select(selector));
    public string LoopSelect<T>(IEnumerable<T> objects, Func<T, object> selector) => Loop(objects.Select(selector));
