...
internal static class ChildOfExtensions
{
    ...
    /// <returns>World matrix or <see cref="float4x4.identity"/> if no <see cref="Transform"/> found</returns>
    [Imp(Inl)]
    ...
    /// </summary>
    /// <param name="entity"></param>
    /// <returns>World matrix or <see cref="float4x4.identity"/> if no parent with <see cref="Transform"/> found</returns>
    [Imp(Inl)]
    ...
    [Imp(Inl)]
    public static float4x4 GetWorldRecursive(this Entity entity)
    {
